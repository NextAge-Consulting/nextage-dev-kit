<!-- VENDORED — do not hand-edit.
     source:   @tanstack/router-core@1.171.18 :: skills/router-core/ssr/SKILL.md
...
> **CRITICAL**: TanStack Router is CLIENT-FIRST. Loaders run on the client by default. With SSR enabled, loaders run on BOTH client AND server. They are NOT server-only like Remix/Next.js loaders. See [router-core/data-loading](./router-data-loading.md).
...
See [router-core/data-loading](./router-data-loading.md) for loader fundamentals.

## Cross-References

- [router-core/data-loading](./router-data-loading.md) — SSR changes where loaders execute
- [compositions/router-query](../SKILL.md) — SSR dehydration/hydration with TanStack Query
