<!-- VENDORED — do not hand-edit.
     source:   @tanstack/start-client-core@1.170.17 :: skills/start-core/execution-model/SKILL.md
...
- [start-core/server-functions](./start-server-functions.md) — the primary server boundary
- [start-core/deployment](./start-deployment.md) — deployment target affects execution
