<!-- VENDORED — do not hand-edit.
     source:   @tanstack/router-core@1.171.18 :: skills/router-core/search-params/SKILL.md
...
- [Validation Patterns Reference](./router-search-params-validation.md) — comprehensive patterns for all validation libraries
