<!-- VENDORED — do not hand-edit.
     source:   @tanstack/start-client-core@1.170.17 :: skills/start-core/server-routes/SKILL.md
...
- [start-core/middleware](./start-middleware.md) — middleware for server routes
- [start-core/server-functions](./start-server-functions.md) — alternative for RPC-style calls
